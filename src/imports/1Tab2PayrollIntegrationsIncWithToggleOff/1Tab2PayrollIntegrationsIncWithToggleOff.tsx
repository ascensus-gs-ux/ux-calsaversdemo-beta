...
function TextContainer() {
  return (
    <div className="d-flex flex-fill flex-column gap-1 align-items-start" data-name="Text Container">
      <p className="fw-semibold w-100" style={{color: '#00594f'}}>Set up a deduction line with your provider</p>
    </div>
  );
}
...
function TextContainer1() {
  return (
    <div className="d-flex flex-fill flex-column gap-1 align-items-start" data-name="Text Container">
      <p className="fw-semibold w-100" style={{color: '#00594f'}}>Log in your CalSavers account and go to Payroll Provider</p>
    </div>
  );
}
...
function TextContainer2() {
  return (
    <div className="d-flex flex-fill flex-column gap-1 align-items-start" data-name="Text Container">
      <p className="fw-semibold w-100" style={{color: '#00594f'}}>Add a bank or select a previously added account</p>
    </div>
  );
}
...
function TextContainer3() {
  return (
    <div className="d-flex flex-fill flex-column gap-1 align-items-start" data-name="Text Container">
      <p className="fw-semibold w-100" style={{color: '#00594f'}}>Initiate Payroll Integrations flow to register for the integration</p>
    </div>
  );
}
